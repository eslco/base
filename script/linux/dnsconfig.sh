...
set_dns_ui() {
    while true; do
        ...
        echo "========================"
        echo "------------------------"
        echo "5. 中國大陸地區DNS優化(HKNet & TW Hinet)"
        echo " v4: 202.67.240.222 & 168.95.1.1"
        echo " v6: 2400:3200::1 & 240e:1f:1::1"
        echo "6. 手動編輯DNS配置"
        echo "------------------------"
        ...
        case "$option" in
			...
			5)
                ...
                dns2_ipv4="168.95.1.1"
                dns1_ipv6="2400:3200::1"
                dns2_ipv6="240e:1f:1::1"
                set_dns
                ;;		
            6)
