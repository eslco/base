...
const foreignNameservers = [
  ...
  //"https://dnslow.me/dns-query",// dnslowme DNS
...
const dnsConfig = {
  ...
  "nameserver-policy": {
    "geosite:private,cn,geosite:cn,geolocation-cn": domesticNameservers,
...
const ruleProviders = {
    ...
    ...ruleProviderCommon,
    behavior: "domain",
    url: "https://raw.githubusercontent.com/254c/base/main/rule/Clash/Wotb/Wotb.txt",
...
function main(config) {
  ...
  config["proxy-groups"] = [
    ...
    }, 
    {
      ...
      "include-all": true,
      icon: "https://fastly.jsdelivr.net/gh/clash-verge-rev/clash-verge-rev.github.io@main/docs/assets/icons/controller.svg",
    },
    {
      ...groupBaseOption,
      name: "Google",
